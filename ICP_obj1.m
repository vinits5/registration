...
helper.objective_function_number = 1;
...
gt_Oval = helper.call_icp_obj1(sensor,model,ref_rotation,ref_translation);      % Minimum value of Obj function at ground truth transfromation.
disp(gt_Oval);
